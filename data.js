...
window.db = {
    ...
    levels: [
        { id: "lvl_th_1", programId: "prog_taheel", name: "المستوى الأول - تأسيس", order: 1 },
        { id: "lvl_th_2", programId: "prog_taheel", name: "المستوى الثاني - تمكين", order: 2 },
        { id: "lvl_ts_1", programId: "prog_taseel", name: "المستوى الأول - أصول وتمهيد", order: 1 },
        { id: "lvl_ts_2", programId: "prog_taseel", name: "المستوى الثاني - تأصيل وتعميق", order: 2 },
        { id: "lvl_ts_3", programId: "prog_taseel", name: "المستوى الثالث - إتقان وبحث", order: 3 },
        { id: "lvl_rs_1", programId: "prog_rasookh", name: "المستوى المتقدم الأول", order: 1 },
        { id: "lvl_rs_2", programId: "prog_rasookh", name: "المستوى المتقدم الثاني", order: 2 }
    ],

    // 4. المجموعات الدراسية[cite: 18]
    groups: [
        { id: "grp_ts_101", levelId: "lvl_ts_1", programId: "prog_taseel", name: "مجموعة الخليل بن أحمد", supervisorId: "supervisor_1" },
        { id: "grp_rs_201", levelId: "lvl_rs_1", programId: "prog_rasookh", name: "مجموعة الشاطبي المتقدمة", supervisorId: "supervisor_1" },
        { id: "grp_th_001", levelId: "lvl_th_1", programId: "prog_taheel", name: "مجموعة البخاري التأسيسية", supervisorId: "supervisor_2" },
        { id: "grp_ts_102", levelId: "lvl_ts_1", programId: "prog_taseel", name: "مجموعة سيبويه التأصيلية", supervisorId: "supervisor_3" }
    ],
    ...
    studentPrograms: [
        { id: "sp_1", studentId: "student_1", programId: "prog_taseel", status: "مستمر", startDate: "2026-01-15", endDate: null },
        { id: "sp_2_old", studentId: "student_2", programId: "prog_taheel", status: "مكتمل", startDate: "2025-09-01", endDate: "2026-01-10" },
        { id: "sp_2_curr", studentId: "student_2", programId: "prog_taseel", status: "مستمر", startDate: "2026-01-15", endDate: null },
        { id: "sp_3", studentId: "student_3", programId: "prog_rasookh", status: "مستمر", startDate: "2026-02-01", endDate: null }
    ],
    ...
    studentPaths: [
        {
            studentId: "student_1",
            history: [
                { programName: "تأصيل", status: "مستمر", period: "2026 - الحالي", isCurrent: true }
            ]
        },
        {
            studentId: "student_2",
            history: [
                { programName: "تأهيل", status: "مكتمل", period: "2025 - 2026", isCurrent: false },
                { programName: "تأصيل", status: "مستمر", period: "2026 - الحالي", isCurrent: true }
            ]
        },
        {
            studentId: "student_3",
            history: [
                { programName: "رسوخ", status: "مستمر", period: "2026 - الحالي", isCurrent: true }
            ]
        }
    ],
    ...
    tasks: [
        ...
        {
            id: "tsk_202",
            title: "أن تعد إدارة البرنامج السؤال الأسبوعي ويكون متعلق بما تم شرحه في هذا الأسبوع",
            programId: "prog_taseel",
            dayOfWeek: 0,
            date: "2026-08-30",
            startTime: "07:00 م",
        ...
        {
            id: "tsk_204",
            title: "أن يسلم للطلاب جدول قراءة الشرح قبل 5 أيام من بداية الدرس الأسبوعي",
            programId: "prog_taheel",
            dayOfWeek: 1,
            date: "2026-08-31",
            startTime: "05:00 م",
        ...
        {
            id: "tsk_101",
            title: "أن يذكر الطلاب بقراءة المقدار الأسبوعي للمتن في المجموعة الطلابية قبل الدرس",
            programId: "prog_taseel",
            dayOfWeek: 1,
            date: "2026-08-31",
            startTime: "08:00 ص",
    ...
    announcements: [
        {
            ...
            content: "نحيط جميع المشرفين الكرام بأنه تم تفعيل خانات التحضير للمهام والجلسات المحددة في الجدول الأسبوعي. يرجى المبادرة برصد حضور الطلاب في وقت الجلسة.",
        ...
        },
        {
            ...
            content: "تقرر عقد الاختبار النصفي لطلاب برنامج التأصيل يوم الأربعاء القادم في تمام الساعة 07:00 مساءً إلكترونياً عبر بوابة الاختبارات.",
