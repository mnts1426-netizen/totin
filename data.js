/**
 * data.js - قاعدة البيانات الشاملة والتشغيلية المعتمدة
 * مسميات المسارات بدون (ال) التعريفية، ومصفوفة المهام الـ 29 المعتمدة.
 */
...
window.db = {
  ...
  // 2. برامج المنصة الأساسية (بدون ال التعريف وبدون أيقونات أو أكواد مسبقة)
  programs: [
    {
      id: "prog_taheel",
      name: "تأهيل",
  ...
  // 7. طلبات تعديل البيانات المقدمة للاعتماد
  pendingProfileEdits: [
    {
      id: "edit_101",
      studentId: "student_1",
